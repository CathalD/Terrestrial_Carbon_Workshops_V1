...
| **Reaches back into** | [Part 2 §5D](../02_Project_Planning/README.md#permanent-or-single-use-plots) and [Part 3](../03_Field_Methods/#3-collect-the-soil-and-root-core) — permanent plots and bulk density are decided there, and cannot be retrofitted |
...
> [Part 3A Stage 4](../03_Field_Methods/#5-separate-the-roots-and-finish-the-records) is for, and it is a
...
structure, a wet year against a dry one. [Part 3](../03_Field_Methods/#3-collect-the-soil-and-root-core) already insists
...
| **Whether roots were removed before soil C** | The [double-counting switch](../03_Field_Methods/#decide-the-reporting-boundary-before-sampling). Flip it between visits and the two stocks are not the same quantity |
...
[Part 3](../03_Field_Methods/#2-measure-the-vegetation) make this point where the numbers are recorded, and
